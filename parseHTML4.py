...
source = "/Users/ickyv/PycharmProjects/QM/articles/UK Publications 501-729 jan-jun.HTML"
f = open(source, 'r')
s = f.read()
...
def stripHTMLTags(s):
    ...
    cleantext = cleantext.replace("7:59", "")
    cleantext = cleantext.replace("4:32", "")
    cleantext = cleantext.replace("12:40", "")
    cleantext = cleantext.replace("2:54", "")
    cleantext = cleantext.replace("9:06", "")
    cleantext = cleantext.replace("4:56", "")
    cleantext = cleantext.replace("8:56", "")
    cleantext = cleantext.replace("1:38", "")
    cleantext = cleantext.replace("2:56", "")
    cleantext = cleantext.replace("9:52", "")
    cleantext = cleantext.replace("9:25", "")
    cleantext = cleantext.replace("9:11", "")
    cleantext = cleantext.replace("1:50", "")
    cleantext = cleantext.replace("4:54", "")
    cleantext = cleantext.replace("5:27", "")
    cleantext = cleantext.replace("10:07", "")
    cleantext = cleantext.replace("8:35", "")
    cleantext = cleantext.replace("2:40", "")
    cleantext = cleantext.replace("10:17", "")
    cleantext = cleantext.replace("8:59", "")
    cleantext = cleantext.replace("7:59", "")
    cleantext = cleantext.replace("(Logo:http: // mma.prnewswire.com / media / 555109 / Holborn_Assets_Limited_Logo.jpg)(Photo: http: // mma.prnewswire.com / media / 555105 / Holborn_Assets_celebrate_fundraising_success.jpg)", "")
    cleantext = cleantext.replace("7:55", "")
    cleantext = cleantext.replace("7:59", "")
    cleantext = cleantext.replace("&auml;", "ä")
    cleantext = cleantext.replace("3:05", "")
    cleantext = cleantext.replace("6:16", "")
    cleantext = cleantext.replace("11:50", "")
    cleantext = cleantext.replace("1:41", "")
    cleantext = cleantext.replace("5:55", "")
    cleantext = cleantext.replace("9:08", "")
    cleantext = cleantext.replace("1:42", "")
    cleantext = cleantext.replace("9:15", "")
    cleantext = cleantext.replace("3:34", "")
    cleantext = cleantext.replace("10:52", "")
    cleantext = cleantext.replace("7:54", "")
    cleantext = cleantext.replace("4:27", "")
    cleantext = cleantext.replace("5:03", "")
    cleantext = cleantext.replace("8:57", "")
    cleantext = cleantext.replace("9:13", "")
    cleantext = cleantext.replace("11:26", "")
    cleantext = cleantext.replace("12:58", "")
    cleantext = cleantext.replace("9:36", "")
    cleantext = cleantext.replace("8:04", "")
    cleantext = cleantext.replace("10:38", "")
    cleantext = cleantext.replace("7:51", "")
    cleantext = cleantext.replace("7:35", "")
    cleantext = cleantext.replace("8:04", "")
    cleantext = cleantext.replace("2:55", "")
    cleantext = cleantext.replace("2:30", "")
    cleantext = cleantext.replace("10:52", "")
    cleantext = cleantext.replace("2:52", "")
    cleantext = cleantext.replace("4:39", "")
    cleantext = cleantext.replace("12:03", "")
    cleantext = cleantext.replace("12:02", "")
    cleantext = cleantext.replace("3:25", "")
    cleantext = cleantext.replace("1:44", "")
    cleantext = cleantext.replace("7:59", "")
    cleantext = cleantext.replace("12:02", "")
    cleantext = cleantext.replace("7:48", "")
    cleantext = cleantext.replace("9:16", "")
    cleantext = cleantext.replace("4:06", "")
    cleantext = cleantext.replace("12:56", "")
    cleantext = cleantext.replace("3:47", "")
    cleantext = cleantext.replace("4:12", "")
    cleantext = cleantext.replace("1:43", "")
    cleantext = cleantext.replace("10:28", "")
    cleantext = cleantext.replace("10:36", "")
    cleantext = cleantext.replace("12:50", "")
    cleantext = cleantext.replace("11:31", "")
    cleantext = cleantext.replace("6:23", "")
    cleantext = cleantext.replace("6:30", "")
    cleantext = cleantext.replace("10:39", "")
    cleantext = cleantext.replace("9:30", "")
    cleantext = cleantext.replace("5:53", "")
    cleantext = cleantext.replace("3:04", "")
    cleantext = cleantext.replace("4:59", "")
    cleantext = cleantext.replace("1:20", "")
    cleantext = cleantext.replace("6:26", "")
    cleantext = cleantext.replace("3:06", "")
    cleantext = cleantext.replace("1:58", "")
    cleantext = cleantext.replace("7:37", "")
    cleantext = cleantext.replace("5:54", "")
    cleantext = cleantext.replace("10:48", "")
    cleantext = cleantext.replace("10:00", "")
    cleantext = cleantext.replace("4:57", "")
    cleantext = cleantext.replace("1:45", "")
    cleantext = cleantext.replace("11:47", "")
    cleantext = cleantext.replace("9:17", "")
    cleantext = cleantext.replace("5:32", "")
    cleantext = cleantext.replace("1:14", "")
    cleantext = cleantext.replace("9:46", "")
    cleantext = cleantext.replace("3:17", "")
    cleantext = cleantext.replace("10:59", "")
    cleantext = cleantext.replace("12:47", "")
    cleantext = cleantext.replace("1:20", "")
    cleantext = cleantext.replace("5:47", "")
    cleantext = cleantext.replace("10:05", "")
    cleantext = cleantext.replace("1:18", "")
    cleantext = cleantext.replace("4:55", "")
    cleantext = cleantext.replace("1:51", "")
    cleantext = cleantext.replace("8:14", "")
    cleantext = cleantext.replace("2:39", "")
    cleantext = cleantext.replace("3:27", "")
    cleantext = cleantext.replace("10:45", "")
    cleantext = cleantext.replace("8:02", "")
    cleantext = cleantext.replace("6:10", "")
    cleantext = cleantext.replace("5:46", "")
    cleantext = cleantext.replace("10:27", "")
    cleantext = cleantext.replace("6:19", "")
    cleantext = cleantext.replace("5:46", "")
    cleantext = cleantext.replace("1:39", "")
    cleantext = cleantext.replace("2:22", "")
    cleantext = cleantext.replace("6:02", "")
    cleantext = cleantext.replace("3:51", "")
    cleantext = cleantext.replace("5:13", "")
    cleantext = cleantext.replace("3:12", "")
    cleantext = cleantext.replace("2:58", "")
    cleantext = cleantext.replace("9:05", "")
    cleantext = cleantext.replace("8:00", "")
    cleantext = cleantext.replace("4:19", "")
    cleantext = cleantext.replace("8:14", "")
    cleantext = cleantext.replace("7:47", "")
    cleantext = cleantext.replace("3:27", "")
    cleantext = cleantext.replace("8:37", "")
    cleantext = cleantext.replace("3:26", "")
    cleantext = cleantext.replace("4:45", "")
    cleantext = cleantext.replace("11:01", "")
    cleantext = cleantext.replace("1:48", "")
    cleantext = cleantext.replace("5:59", "")
    cleantext = cleantext.replace("10:27", "")
    cleantext = cleantext.replace("4:44", "")
    cleantext = cleantext.replace("6:22", "")
    cleantext = cleantext.replace("6:06", "")
    cleantext = cleantext.replace("1:45", "")
    cleantext = cleantext.replace("6:30", "")
    cleantext = cleantext.replace("4:58", "")
...
def removeDocumentNumber(text):
    ...
    for line in textList:
        if(line.find("of 229 DOCUMENTS") != -1):
